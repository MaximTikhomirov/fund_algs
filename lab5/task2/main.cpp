...
int main(){
    ...
    std::string input_fife = "cat1.jpg";
    std::string output_file = "123.txt";
    std::string encrypted = "129.txt";
    Encoder shifr{key};
    shifr.encode("cat1.jpg", encrypted, true);
    shifr.encode(encrypted, "123.txt", true);
    return 0;
}